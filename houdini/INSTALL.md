# LentilKarma for Houdini 20.5 — Installation Guide
...
Copy `LentilKarma.json` to your Houdini packages directory:
...
{
    "env": [
        { "LENTILKARMA": "C:/path/to/LensSim-3.2.0" }
    ],
...
result = lentilkarma_houdini.apply_lens_to_camera(
    "C:/path/to/LensSim-3.2.0/LentilKarma_Data/lenses/100mm f1.4 W Merte 1928 Baltar.txt"
)
```
